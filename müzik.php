...
$secim = "SELECT * FROM resimlermuzik";
...
if ($calistir) {
    ...
    <img src='<?php echo $row["resim_url2"]; ?>' alt='' style="max-width: 500px; height: auto;"> 
    <h3 style="color: #333; font-size: 18px; margin-bottom: 5px;"><?php echo $row["baslik2"]; ?></h3>
    <p style="margin-top: 5px;"><?php echo $row["aciklama2"]; ?></p><br>
</div>
