...
<header>
    ...
    <div class="onecikanlar">
        <br><br>
        <h2>BU AYIN ÖNE ÇIKAN ETKİNLİKLERİ</h2>
    </div>
    <br><br><br>
    <?php
include("baglanti.php");

$secim = "SELECT * FROM etkinlikresim";
$calistir = mysqli_query($baglanti, $secim);

if ($calistir) {
    if (mysqli_num_rows($calistir) > 0) {
        echo '<div class="photo-album" style="margin-left:100px;">';
        while ($row = mysqli_fetch_assoc($calistir)) {

            echo '<div class="photo">';
            echo '<img src="' . $row["resim_url"] . '" alt="Etkinlik Resmi">';
            echo '</div>';
        }
        echo '</div>';
    } else {
